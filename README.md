...
`kCenterWindow` started out as a simple script I built for myself, specifically the need to quickly pop a window into the center to focus on it, and then instantly return it back to where it was.
